...
class HomeController extends Controller
{
    ...
    public function index()
    {
        if(Auth::user()->role == 'bank'){
            ...
            $mutasi = Wallet::where('status', 'selesai')->orderBy('created_at', 'DESC')->paginate(4);
            

            return view('home', compact('saldo','nasabah','transactions', 'transactionAll','request_topup','mutasi'));
        }
